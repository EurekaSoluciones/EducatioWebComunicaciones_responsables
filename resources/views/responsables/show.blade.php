                      ...
                      <div class="col-4 w-100">
                        ...
                        <div class="card card-widget widget-user">
                          <div class="widget-user-header {{$alumno->BG}}">
                            <h3 class="widget-user-username textColorSegunBG">{{$alumno->nombreYApellido}}</h3>
                          </div>

                          <div class="card-body">

                            <div class="widget-user-image">
                              <img class="img-circle elevation-2" src="{{$alumno->SafeAvatarImg}}" alt="User Avatar">
                            </div>
                            ...
                            <div class="text-center" style="clear: both">
                              ...
                              @if ($alumno->Fecha_Baja == null)
                                <h4 class="">Grado</h4>
                                <p class="text-muted text-sm">
                                  {{$alumno->grupo->ECurso->Descripcion}} {{$alumno->grupo->EDivision->Descripcion}}
                                </p>
                                ...
                                <a class="btn btn-primary" href="{{route('alumnos.show', $alumno)}}">Ver Perfil</a>
                              @endif
