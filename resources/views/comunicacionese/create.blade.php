...
@section('content')
  ...
  <div class="col-md-10 offset-md-1">
    ...
    <div class="card card-info card-outline">
      ...
      <form id="comunicacionForm" name="comunicacionForm" action="{{ route('comunicaciones.e.store', $alumno) }}" method="POST">
        @csrf
                ...
                <div class="card card-widget widget-user ">
                  ...
                  <div class="card-body">
                    ...
                    <div class="widget-user-image">
                      <img class="img-circle elevation-2" src="{{$user->SafeAvatarImg}}" alt="User Avatar">
                    </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="form-group">
                      ...
                      <select class="select2bs4 select2-hidden-accessible"
                              data-placeholder="Seleccione los destinatarios"
                              style="width: 100%;" data-select2-id="54" tabindex="-1" aria-hidden="false"
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control w-100" id="asunto" name="asunto" placeholder="Texto"
    ...
    Dropzone.options.dropzone =
      {
        ...
        removedfile: function (file) {
          ...
          $.ajax({
            ...
            data: {filename: name, tempId: $('#tempId4DZ').val()},
