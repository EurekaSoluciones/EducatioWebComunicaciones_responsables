...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-2 text-right d-flex align-items-center justify-content-center">
            <a href="{{ route('comunicaciones.e.create', $alumno) }}" class="btn btn-primary"><i
                    class="fas fa-paper-plane"></i> Nuevo mensaje a la institución</a>
        </div>
    </div>
                    ...
                    @foreach ($comunicacionese as $ce)
                        ...
                        <tr class="align-middle">
                            ...
                            <td class="align-middle">
                                @if ($ce->destinatario_web_user && $ce->destinatario_web_user->safeAvatarImg)
                                    <img src="{{ $ce->destinatario_web_user->safeAvatarImg }}" class="img-circle mr-2"
                                        style="height: 42px">
                                    {{ $ce->destinatario_web_user->nombreYApellido }}
                                @else
                                    <img src="" class="img-circle mr-2" style="height: 42px">
                                    {{ $ce->destinatario_web_user->nombreYApellido }}
                                @endIf
